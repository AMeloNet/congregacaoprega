...
Status: a base Vitest/Playwright e o workflow da CI foram incorporados à
`main` no PR #5. Os cenários de negócio abaixo ainda não foram implementados nem
...
Os cenários de identidade estão em [cenarios-identidade.md](cenarios-identidade.md).
